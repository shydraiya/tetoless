...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        [Tooltip("When enabled, orthographic cameras flatten the bolt to camera-style 2D coordinates.")]
        public bool UseOrthographicMode = true;
        ...
        private void Start()
        {
            orthographic = UseOrthographicMode && Camera.main != null && Camera.main.orthographic;
